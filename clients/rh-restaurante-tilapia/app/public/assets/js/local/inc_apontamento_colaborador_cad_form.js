...
function fcAbrirApontamentoOperacionalControlePonto(colaborador_pk,dt_apontamento) {
...
function fcValidarFormulario(){
    ...
    switch(tipo_apontamento_pk){
        ...
        case "11":{
            var v_hr_ini_abono = $("#hr_ini_abono").val();
            var v_hr_ini_intervalo_abono = $("#hr_ini_intervalo_abono").val();
            var v_hr_termino_intervalo_abono = $("#hr_termino_intervalo_abono").val();
            var v_hr_termino_abono = $("#hr_termino_abono").val();
            var v_colaborador_pk = $("#colaborador_pk_modal").val();
            var v_leads_pk = leads_pk;
            ...
            var objParametros = {
                ...
                "tipo_apontamento_pk": (v_tipo_apontamento_pk),
                "dt_apontamento": (v_dt_apontamento),
                "hr_ini_abono": (v_hr_ini_abono),
                "hr_ini_intervalo_abono": (v_hr_ini_intervalo_abono),
                "hr_termino_intervalo_abono": (v_hr_termino_intervalo_abono),
                "hr_termino_abono": (v_hr_termino_abono),
            };
...
$(document).ready(function () {
    ...
    $(document).on('click', '#cmdEnviar', fcValidarFormulario);
    $(document).on('click', '#cmdEnviar1', fcValidarFormulario);
