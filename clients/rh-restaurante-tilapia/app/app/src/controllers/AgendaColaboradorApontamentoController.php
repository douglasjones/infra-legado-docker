...
final class AgendaColaboradorApontamentoController extends BaseController {
    ...
    public function salvar(Request $request, Response $response, $args){
        try{
            ...
            $hr_ini_abono = isset($data['hr_ini_abono'])? $data['hr_ini_abono'] : "";
            $hr_ini_intervalo_abono = isset($data['hr_ini_intervalo_abono'])? $data['hr_ini_intervalo_abono'] : "";
            $hr_termino_intervalo_abono = isset($data['hr_termino_intervalo_abono'])? $data['hr_termino_intervalo_abono'] : "";
            $hr_termino_abono = isset($data['hr_termino_abono'])? $data['hr_termino_abono'] : "";
            $dt_abono = Util::DataYMD($dt_apontamento);
            ...
            if($tipo_apontamento_pk == 3){
                ...
                $entity->salvarFolga($apontamentoFolga);
            }
            if($tipo_apontamento_pk == 11){
                //ABONO É PRA SALVAR EM FALTA MESMO
                $apontamentoAbono = [
                    "pk"=>"",
                    "agenda_colaborador_apontamento_pk"=>$retorno->data,
                    "lead_pk"=>$leads_pk,
                    "dt_falta"=>$dt_abono,
                    "hr_ini_abono"=>$hr_ini_abono,
                    "hr_ini_intervalo_abono"=>$hr_ini_intervalo_abono,
                    "hr_termino_intervalo_abono"=>$hr_termino_intervalo_abono,
                    "hr_termino_abono"=>$hr_termino_abono,
                    
                ];
                $entity->salvarAbono($apontamentoAbono);
            }
