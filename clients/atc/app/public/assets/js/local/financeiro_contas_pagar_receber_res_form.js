...
function fcLimparPeriodosFinanceiro(sufixo, manter) {
    ['cadastro', 'faturamento', 'vencimento', 'pagamento'].forEach(function (campo) {
        if (campo === manter) {
            return;
        }
        var nome = 'date_range_filter_' + campo + '_' + sufixo;
        $('input[name="' + nome + '"]').val('');
...
$(document).ready(function () {
    ...
    componentDateRangePicker.on('apply.daterangepicker', function (ev, picker) {
        ...
        fcLimparPeriodosFinanceiro('receita', 'cadastro');
        $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
        localStorage.setItem('date_range_filter_cadastro_receita', picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
    ...
    componentDateRangePicker.on('apply.daterangepicker', function (ev, picker) {
        ...
        fcLimparPeriodosFinanceiro('receita', 'faturamento');
        $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
    ...
    var startVencReceita = moment().startOf('month');
    var endVencReceita = moment().endOf('month');
    ...
    componentDateRangePicker.on('apply.daterangepicker', function (ev, picker) {
        ...
        fcLimparPeriodosFinanceiro('receita', 'vencimento');
        $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
    ...
    componentDateRangePicker.on('apply.daterangepicker', function (ev, picker) {
        ...
        fcLimparPeriodosFinanceiro('receita', 'pagamento');
        $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
    ...
    //Event apply date
    componentDateRangePicker.on('apply.daterangepicker', function (ev, picker) {
        fcLimparPeriodosFinanceiro('despesa', 'cadastro');
        $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
    ...
    componentDateRangePicker.on('apply.daterangepicker', function (ev, picker) {
        ...
        fcLimparPeriodosFinanceiro('despesa', 'faturamento');
        $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
    ...
    var startVencDespesa = moment().startOf('month');
    var endVencDespesa = moment().endOf('month');
    ...
    componentDateRangePicker.on('apply.daterangepicker', function (ev, picker) {
        ...
        fcLimparPeriodosFinanceiro('despesa', 'vencimento');
        $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
    ...
    componentDateRangePicker.on('apply.daterangepicker', function (ev, picker) {
        ...
        fcLimparPeriodosFinanceiro('despesa', 'pagamento');
        $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
