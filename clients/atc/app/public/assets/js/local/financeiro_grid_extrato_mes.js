...
function fcCarregarGridExtrato(){
    ...
    if(!arrCarregar || arrCarregar.status !== true || !arrCarregar.data || arrCarregar.data.length === 0){
        $('#totalExtratoReceita').html('0,00');
        $('#totalExtratoDespesa').html('0,00');
        $('#totalExtratoSaldo').html('0,00');
        $('#totalExtratoSaldoMesAnterior').html('0,00');
        $('#totalExtrato').html('0,00');
        return;
    }
