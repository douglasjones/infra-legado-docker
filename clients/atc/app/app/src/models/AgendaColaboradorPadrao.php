...
class AgendaColaboradorPadrao {
    ...
    public function pegarPostoByColaboradorPorMesAno($dt_inicio,$dt_fim,$colaborador_pk){
        ...
        $sql.=" and acp.dt_inicio_agenda <= '".$ultimoDiaMesAtual."'";
        $sql.=" and (acp.dt_fim_agenda IS NULL or acp.dt_fim_agenda >= '".$primeiroDiaMesAtual."')";
        ...
        $sql.=" group by acp.pk ";
        $sql.=" order by acp.dt_cancelamento is not null, acp.dt_inicio_agenda desc, acp.pk desc ";
