...
?>
<script src="rel_movimentacao_produto_fornecedor.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
                ...
                <div class="col-lg"  style="max-width:1000px;margin-left: auto;margin-right: auto;">
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class='col-md-4'>
                                <label for='ds_tel'>Fornecedor: </label>
                                <select type='text' class='form-control form-control-sm chzn-select'  id='fornecedor_pk' name='fornecedor_pk'>
                                    <option></option>
                                </select>
                            </div>            
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4" align="center">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="fcCarregarGridMovimentacaoProdutoFornecedor">Gerar Relatório</button>                         
                                </div>
                            </div>
                        </div>
                    </div>
