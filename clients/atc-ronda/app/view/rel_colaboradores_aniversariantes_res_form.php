...
?>
<script src="rel_colaboradores_aniversariantes_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Colaboradores Aniversariantes do Mês</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">   
        ...
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for='ds_mes_aniversario'>Mês: </label>
                <select type='text' class='form-control form-control-sm chzn-select'  id='ds_mes_aniversario' name='ds_mes_aniversario'>
                    <option></option>
