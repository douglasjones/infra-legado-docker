...
?>
<script src="rel_fatura_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    ...
    <form id="form" class="form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Empresa</label>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Cliente</label>
