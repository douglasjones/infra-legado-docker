...
function fcCarregarGrid(){  
   ...
   var strRetorno = "";
    ...
    var arrCarregarc = carregarController("ponto", "listarColaboradorPontoSistema", objParametrosc); 
    ...
    if (arrCarregarc.result == 'success'){
        if(arrCarregarc.data.length > 0){
           ...
           for(i = 0; i< arrCarregarc.data.length; i++){
                ...
                var arrCarregarP = carregarController("ponto", "relatorioPontoSistema", objParametrosP); 
                        ...
                        if(arrCarregarP.data.length>0){
                            ...
                            for(j=0; j < arrCarregarP.data.length ;j++){  
                               ...
                               if(arrCarregarP.data[j]['ds_distancia_entre_pontos']!= null){
                                ...
                                if(arrCarregarP.data[j]['ds_imagem_entrada']==null){
                                    ds_imagem_entrada="../img/usuario_sem_imagem.png";
                                }else{
                                     ds_imagem_entrada=arrCarregarP.data[j]['ds_imagem_entrada'];
                                }

                                if(arrCarregarP.data[j]['ds_imagem_sistema']==null){
                                    ds_imagem_sistema="../img/usuario_sem_imagem.png";
                                }else{
                            ...
                            strRetorno+="           <th colspan=1  align=center>&nbsp;</th>";
                            strRetorno+="       </tr>";
                            strRetorno+="<tr>";
                            strRetorno+="           <th colspan=14  align=center>&nbsp;</th>";
                            strRetorno+="       </tr>";
                            somar_segundos = "";
                            segundo_ponto = "";
                            segundo_intervalo = "";
...
function fcCancelar(){
    ...
    sendPost("rel_ponto_sistema_colaborador_res_form.php", {token: token});
}
