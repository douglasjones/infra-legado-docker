...
<script src="processo_default_config.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
                ...
                <div class="card-body">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="dados" role="tabpanel" aria-labelledby="dados-tab">
                            ...
                            <div class='row'>
                                <div class='col-md-4'>                        
                                    <input type="checkbox" id="processo_default_configuracao_pk" name="processo_default_configuracao_pk"> Comercial           
                                </div>              
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>                        
                                    <input type="checkbox" id="processo_default_configuracao_pk" name="processo_default_configuracao_pk"> Administrativo                             
                                </div>              
                            </div>
                            <div class='row'>                    
                                <div class='col-md-4'>                        
                                    <input type="checkbox" id="processo_default_configuracao_pk" name="processo_default_configuracao_pk"> Financeiro                             
                                </div>              
                            </div>
                            <br>
                            <div class='row'>                    
                                <div class='col-md-4'>  
                                    ...
                                    <textarea rows="5" cols="50" class='form-control form-control-sm ' type="checkbox" id="obs" name="obs"></textarea>                       
                                </div>              
                            </div>
                            <br>
                        </div>
