...
<script src="lancamento_cad_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>

<form id="form_recebimento" class="form">
    <input type="hidden" id="titulo" value="">
    <div class="modal fade bd-example-modal-lg" id="modal_lancamento" >
        <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" ><label id="label_titulo"></label></h5>
