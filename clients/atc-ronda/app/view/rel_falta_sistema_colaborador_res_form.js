...
function fcCarregarGrid(){
    ...
    sendPost('rel_falta_sistema_colaborador_cad_form.php', {token: token, colaboradores_pk: $("#colaboradores_pk").val(),ds_colaboradores: v_ds_colaborador,dt_ini: $("#dt_ini").val(),dt_fim: $("#dt_fim").val(),leads_pk: $("#ds_lead").val(),ds_lead: v_ds_lead});
}
