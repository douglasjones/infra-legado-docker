...
?>
<script src="rel_apontamento_colaborador_cad_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
<style>
    ...
    <div class="container col-md-12">
        ...
        <form id='form'>
            <table>
                ...
                <tr>
                    <td>
                         <b>Tipo Apontamento:</b>
                    </td>
                    <td>
                       <div id="ds_tipo_apontamento"></div>
                    </td>
                </tr>
                <tr>
                    <td>
