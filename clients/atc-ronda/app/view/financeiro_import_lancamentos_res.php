...
?>
<script src="financeiro_import_lancamentos_res.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
<div class="container">
	<br>
	<div class="row">
		<div class="col-lg">
				...
				<div class="card-header py-3">	
                    <div class="row">
                        ...
                        <div class='col-sm-6' align="Right">
                            ...
                            &nbsp;
                            <button type="button" class="btn btn-primary btn-sm" id="cmdImportar">Importar</button>                       
                        </div>
                    </div>
				</div>
				<div class="card-body">
