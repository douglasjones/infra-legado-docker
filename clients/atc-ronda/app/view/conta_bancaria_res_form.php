...
?>
<script src="conta_bancaria_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    ...
    <form method="post">
         <div class="row">
            ...
            <div class='col-md-4'>
                <label for="ds_caonta">Banco(s):&nbsp;</label>
        ...
        <div class="row">
            ...
            <div class='col-md-2'>
                <label for="ds_caonta">Conta(s):&nbsp;</label>
