...
function fcIncluir(){
    ...
    sendPost('categoria_produto_cad_form.php',{token: token, pk: ''});
...
function fcEditar(v_pk){
    sendPost('categoria_produto_cad_form.php', {token: token, pk: v_pk});
}
...
function fcCarregarGrid(){
    ...
    var v_url = montarUrlController("categoria_produto", "listarDataTable", objParametros);
