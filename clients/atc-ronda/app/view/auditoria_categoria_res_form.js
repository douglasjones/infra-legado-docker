...
function fcIncluir(){
    ...
    sendPost('auditoria_categoria_cad_form.php',{token: token, pk: ''});

}

function fcExcluir(v_pk, v_ds_categoria){

    if (confirm("Deseja realmente excluir o registro '" + v_ds_categoria + "'?")){
        if(v_pk != ""){
            ...
            var arrExcluir = carregarController("auditoria_categoria", "excluir", objParametros);
...
function fcEditar(v_pk){
    sendPost('auditoria_categoria_cad_form.php', {token: token, pk: v_pk});
}
...
function fcCarregarGrid(){
    ...
    var v_url = montarUrlController("auditoria_categoria", "listarDataTable", objParametros);
