...
?>
<script src="rel_escala_servico_dia_grid_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório Escala de Serviço Dia</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">
        <div class="row">
            ...
            <div class='col-md-2'>
                <label for='ds_tel'>Escala Dia: </label>
        ...
        <p>
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Turnos</label>
