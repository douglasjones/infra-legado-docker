...
<script src="login_holerite_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>  
...
<div class="container">
    <div class="wrapper">
        <form id="form" class="form-signin" >
            ...
            <div class="row">
                <div class="col" align="center">
                    <button type="button" class="btn btn-lg btn-primary btn-block" id="cmdEnviar">Acessar</button>
                </div>               
            </div>
            <div class="row">
