                        ...
                        if(arrCarregarP.data.length>0){
                            ...
                            for(j=0; j < arrCarregarP.data.length ;j++){  
                               ...
                               if(arrCarregarP.data[j]['ds_distancia_entre_pontos']!= null){
                                ...
                                strRetorno+="<td align=center  width='40%' class='galeria'><img src="+ds_imagem_entrada+" width='40'</td>";
                                ...
                                strRetorno+="<td align=center  width='60%'><a onclick='fcAbrirMapa("+'"'+ds_local_trabalho+'"'+","+'"'+$ds_localizacao+'"'+")'><span><img width=18 height=18 src='../img/localizacao.png' title='Maps'></span></a></td>";
                                strRetorno+="</tr>";
