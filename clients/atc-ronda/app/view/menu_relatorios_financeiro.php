						...
						<div class="col-sm"> 
                            <div class=' col-sm text-left'>
                                <a href="javascript: abrirMenu('rel_lancamento_res_form.php');">
                                    ...
                                    <label  style="font-size: 15px">Fluxo de Caixa</label>
                                </a>
                            </div>
                            <br>
                            ...
                            <div class=' col-sm text-left'>
                                <a href="javascript: abrirMenu('rel_lancamento_pago_res_form.php');">
                                    <i class="bi bi-clipboard2-data" style="font-size:30px; color:black"></i>
                                    <label  style="font-size: 15px">Acompanhamento de Lançamentos Financeiros Pagos</label>
                                </a>
                            </div> 							         
						</div> 
						<div class="col-sm"> 
                            ...
                            <div class=' col-sm text-left'>
                                <a href="javascript: abrirMenu('rel_titulo_plano_contas_res_form.php');">
                                    <i class="bi bi-clipboard2-data" style="font-size:30px; color:black"></i>
                                    <label  style="font-size: 15px">Títulos por Plano de Contas</label>
                                </a>
                            </div>  
                            <!--<br>
                            <div class=' col-sm text-left'>
                                <a href="javascript: abrirMenu('rel_titulo_por_vencimento_res_form.php');">
                                    <i class="bi bi-clipboard2-data" style="font-size:30px; color:black"></i>
                                    <label  style="font-size: 15px">Títulos por Vencimento</label>
                                </a>
                            </div>-->  
                           <!-- <br>
                            <div class=' col-sm text-left'>
                                <a href="javascript: abrirMenu('rel_lancamento_pago_res_form.php');">
                                    <i class="bi bi-clipboard2-data" style="font-size:30px; color:black"></i>
                                    <label  style="font-size: 15px">Contas a Pagar - Receber - Fornecedor - Cliente</label>
                                </a>
                            </div>  -->
						</div>
					</div>
