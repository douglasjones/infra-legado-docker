...
function fcCarregarGridMovimentacaoCustoMedio(){
    ...
    var arrCarregar = carregarController("movimentacao_estoque", "relatorioMovimentacaoProdutoFornecedor", objParametros); 
...
function fcCancelar(){
    ...
    sendPost("rel_movimentacao_produto_fornecedor.php", {token: token});
}
