<script src="colaborador_controle_escala_cad_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form id="form_contato">
                        ...
                        <input type='hidden' class='form-control form-control-sm'  id='acao_agenda' name='acao_agenda'>
                            ...
                            <div class="row">
                                <div class='col-md-4'>
                                    ...
                                    <select class='form-control form-control-sm'  id='contratos_pk_combo' name='contratos_pk_combo' >
                                        <option><option>
                                    </select>
                                </div>    
                                <div class="col-md-8">
                            ...
                            <div class="row">
                                <!--div class='col-md-4'>
                                    ...
                                    <div id="exibir_variavel_processo" style="display:none">
                                        ...
                                        <input type='hidden'   id='processos_etapas_pk_2' name='processos_etapas_pk_2' >
                                        <input type='hidden'  id='agenda_contratos_itens_pk' name='agenda_contratos_itens_pk'>
                                        <input type='hidden'  id='n_qtde_dias_semana' name='n_qtde_dias_semana'>
                                        <input type='hidden'  id='contratos_itens_pk' name='contratos_itens_pk'>
                                    </div>
                                
                                <!--/div-->
                                <div class='col-md-4'>                                    
                                    <label for='dt_inicio_agenda'>Data Início da Escala: </label>
                                    <input type='text' class='form-control form-control-sm' maxlength="10"  id='dt_inicio_agenda' name='dt_inicio_agenda'>
                                </div>                                
                                <div class='col-md-4'>
                                    <label for='dt_fim_agenda'>Data Fim Termino do Contrato: </label>
                                    <input type='text' class='form-control form-control-sm' maxlength="10"  id='dt_fim_agenda' name='dt_fim_agenda'>
                                </div>                                           
                            </div> 
                            <p> 
                            <div id="exibir_data_cancelamento" style="display:none">
                                <h5>Cancelar Escala</h5>
                                <hr style='height:1px; border:none; color:#14074F; background-color:#14074F; margin-top: 0px; margin-bottom: 0px;'>
                                <div class="row">
                                    <div class='col-md-4'>
                            ...
                            <div class="row">
                                <div class='col-md-4'>
                                    ...
                                    <select class='form-control form-control-sm'  id='produtos_servicos_pk_combo' name='produtos_servicos_pk_combo' />
                                        <option></option>
                                    </select>
                                </div>
                              
                               <div class='col-md-10' >           
                                    <b><div id="print_dias_por_servico"></div></b>
                                    <input type="hidden" id="dias_escala_servico" name="dias_escala_servico" value="">
                                </div>
                            ...
                            <div class="row">
                                <div class='col-md-5' >
                                    ...
                                    <select class='form-control form-control-sm'  id='colaboradores_pk_combo_agenda' name='colaboradores_pk_combo_agenda' />
                                        <option></option>
                                    </select>
                                </div> 
                                <div class='col-md-6' >
                                    <b><div id="print_escala_colaborador"></div></b>
                                </div>    
                            </div> 
                            <p>
                            <h5>Horários e Turnos</h5>
                            <hr style='height:1px; border:none; color:#14074F; background-color:#14074F; margin-top: 0px; margin-bottom: 0px;'>
                            ...
                            <div class="row">
                                <div class='col-md-3' >
                                    <label for='colaboradores_pk_agenda'>HR Saída Intervalo: </label>
                                ...
                                <div class='col-md-3' >
                                    <label for='colaboradores_pk_agenda'>Instrajornada: </label>
                                    <input type="checkbox" name='ic_intrajornada' id='ic_intrajornada' />
                                </div>   
                            </div> 
                            <p>
                            <div class="row">                                
                                <div class='col-md-8'  >
                                    <label for='colaboradores_pk_agenda'>Inverter Folga semana seguinte? (Escalas 12x36)</label>
                                    <input type="checkbox" id="ic_folga_inverter" name="ic_folga_inverter">
                                </div> 
                            </div>
                            <div class="row">
                                <div class='col-md-4' >
                                    <label for='colaboradores_pk_agenda'>Tipo Escala (Escalas 12x36):</label>
                                    <select class='form-control form-control-sm' id="tipo_escala" name="tipo_escala">
                                        <option ></option>
                                        <option value="1">Impar</option>
                                        <option value="2">Par</option>
                                    </select>
                                    <div class='row' id="alert_tipo_escala" style="display:none">
                                        <strong style="color: red">Por favor, informe O Tipo da Escala</strong>
                                    </div>
                                </div>
                            </div>
                            <p>
                            ...
                            <div class='row'>
                                <div class='col-md-12'>
                                    <table class="table table-striped table-bordered nowrap" style="width:100%" id='tblAgendaTurno'>
                                        ...
                                        <tbody>
                                            <tr style=" background: #BFEFFF; font-size: 14px ">
                                                <td><b>Folga</b></td>
                                                <td>
                                            ...
                                            <tr style=" background: #EEEEEE; font-size: 14px ">
                                                <td><b>Escala</b></td>
                                                <td>
                                            ...
                                            <tr style=" background: #FFFFFF; font-size: 14px ">
                                                <td>Turno</td>
                                                <td>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="cmdEnviarAgenda" name="cmdEnviarAgenda" onclick="fcValidarFormAgendas()">Salvar</button>
                            </div>
                    </div>
                </div>
            </div>  
