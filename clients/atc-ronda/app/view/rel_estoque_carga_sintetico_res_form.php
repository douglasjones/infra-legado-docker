...
?>
<script src="rel_estoque_carga_sintetico_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório Estoque Sintético</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Data Movimentacao:</label>
            </div>
        </div>  
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <input class='form-control form-control-sm'  id='dt_movimentacao_ini' name='dt_movimentacao_ini'>
            </div>
            <div class="col-md-2">
                <input class='form-control form-control-sm'  id='dt_movimentacao_fim' name='dt_movimentacao_fim'>
            </div>
        </div> 
        <br>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for='ds_tel'>Categoria: </label>
                <select type='text' class='form-control form-control-sm chzn-select'  id='categorias_pk' name='categorias_pk'>
                    <option></option>
                </select>
            </div>            
        </div>
        ...
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for='ds_tel'>Produtos: </label>
