...
function fcIncluir(){
    ...
    sendPost('beneficio_cad_form.php',{token: token, pk: ''});

}

function fcExcluir(v_pk, v_ds_beneficio){

    if (confirm("Deseja realmente excluir o registro '" + v_ds_beneficio + "'?")){
        if(v_pk != ""){
...
function fcEditar(v_pk){
    sendPost('beneficio_cad_form.php', {token: token, pk: v_pk});
}
...
function fcCarregarGrid(){
    ...
    var v_url = montarUrlController("beneficio", "listarDataTable", objParametros);
