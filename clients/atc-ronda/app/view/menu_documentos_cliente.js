function fcCarregarGridDocumentos(){
    ...
    var leads_pk = $("#leads_usuarios_pk").val()
    var ic_tipo_documento = 2;
    var objParametros = {   
        "leads_pk": leads_pk,
...
function fcFormatarGriDocumentos(){    
    tblDocumentos.clear().destroy();
    fcCarregarGridDocumentos()
}
$(document).ready(function(){
    //fcFormatarGriDocumentos();
    ...
    $(document).on('change', '#leads_usuarios_pk', fcFormatarGriDocumentos);
    fcCarregarGridDocumentos();
    //fcCarregarGridDocumentos()
