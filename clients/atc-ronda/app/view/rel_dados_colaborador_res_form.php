...
?>
<script src="rel_dados_colaborador_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório Dados Colaboradores</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">
        ...
        <div class="row">                        
            ...
            <div class='col-md-4'>
                <label for='tipo_ocorrencia_pk'>Ativos&nbsp;</label>
