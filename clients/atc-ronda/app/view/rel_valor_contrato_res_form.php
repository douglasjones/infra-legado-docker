...
?>
<script src="rel_valor_contrato_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório Valor Contrato</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Data Contrato:</label>
            </div>
        </div>  
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <input class='form-control form-control-sm'  id='dt_contrato_ini' name='dt_contrato_ini'>
            </div>
            <div class="col-md-2">
                <input class='form-control form-control-sm'  id='dt_contrato_fim' name='dt_contrato_fim'>
            </div>
        </div> 
        <br>
        <hr style='height:1px; border:none; color:#14074F; background-color:#14074F; margin-top: 0px; margin-bottom: 0px;'>
