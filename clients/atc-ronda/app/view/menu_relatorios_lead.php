                ...
                <div class="card-header py-3">	
                    <div class="row">
                        <div class='col-sm-6' align="left">
                            <h6 class="m-0 font-weight-bold text-primary">Relatórios Clientes / Postos de Trabalho / Contratos </h6>
                        </div> 
							...
							<div class="text-left">
								<div class=' col-sm text-left'>
                                    <a href="javascript: abrirMenu('rel_posto_trabalho_analitico_res_form.php');">
										...
										<label  style="font-size: 15px">Posto(s) de Trabalho Análitico</label>
									</a>
								</div>
							</div>  
							<br>
							<div class=' col-sm text-left'>
                                <a href="javascript: abrirMenu('rel_ronda_res_form.php');">
									<i class="bi bi-clipboard2-data" style="font-size:30px; color:black"></i>
									<label  style="font-size: 15px">Rondas</label>
								</a>
							</div>
							<br>
							<div class=' col-sm text-left'>
                                <a href="javascript: abrirMenu('rel_movimentação_ft_res_form.php');">
									<i class="bi bi-clipboard2-data" style="font-size:30px; color:black"></i>
									<label  style="font-size: 15px">Movimentação FT</label>
								</a>
							</div>                         
						</div> 
						<div class="col-sm"> 			
							<div class="text-left">
								<div class=' col-sm text-left'>
                                    <a href="javascript: abrirMenu('rel_posto_trabalho_colaboradores_res_form.php');">
									    <i class="bi bi-clipboard2-data" style="font-size:30px; color:black"></i>
									    <label  style="font-size: 15px">Postos de Serviços X Colaboradores</label>
								    </a>
								</div>
							</div>  						
						</div>  
