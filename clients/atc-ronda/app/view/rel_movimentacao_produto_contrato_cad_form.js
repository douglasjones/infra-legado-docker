...
function fcCarregarGridMovimentacaoEstoqueProduto(){
    ...
    var arrCarregar = carregarController("movimentacao_estoque", "relatorioMovimentacaoEstoqueProduto", objParametros); 
    ...
    if (arrCarregar.result == 'success'){
        ...
        if(arrCarregar.data.length > 0){   
                    ...
                    strRetorno+="<th width='20%'>Op.</th>";
                    strRetorno+="<th width='20%'>Quant</th>";
                    strRetorno+="<th width='20%'>Vl. Unitario</th>"; 
                    strRetorno+="<th width='20%'>Vl. Total</th>";
                    ...
                    for(i=0; i < arrCarregar.data.length ;i++){
                        if(arrCarregar.data[i]['t_ds_lead']==null){
                            ...
                            var ds_lead1 = arrCarregar.data[i]['t_ds_lead'];
                        }
                        ...
                        if(arrCarregar.data[i]['t_vl_item']==null){
                            var t_vl_item1 = "";
                        }
                        else{
                            var t_vl_item1 = arrCarregar.data[i]['t_vl_item'];
                        }
                        if(arrCarregar.data[i]['vl_total_item']==null){
                            var vl_total_item1 = "";
                        }
                        else{
                            var vl_total_item1 = arrCarregar.data[i]['vl_total_item'];
                        }
                        ...
                        strRetorno+="<th width='20%'>"+t_vl_item1+"</th>";
                        strRetorno+="<th width='20%'>"+vl_total_item1+"</th>";
...
function fcCancelar(){
    ...
    sendPost("rel_movimentacao_produto_contrato.php", {token: token});
}
