...
?>
<script src="supervisao_auditoria_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="ic_status" class="form-control form-control-sm" name="ic_status">
                    <option value=""></option>
                    <option value="1">Pendente</option></option>
                    <option value="2">Feita</option>
                </select>
            </div>
        </div>
        <div class="row">
