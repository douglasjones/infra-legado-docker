...
function fcCarregarGrid(){
    ...
    var arrCarregar = carregarController("movimentacao_estoque", "RelatorioEstoqueMinimo", objParametros); 
    ...
    if (arrCarregar.result == 'success'){
        ...
        if(arrCarregar.data.length > 0){   
                    ...
                    for(i=0; i < arrCarregar.data.length ;i++){
                       ...
                       if(arrCarregar.data[i]['dt_cad_estoque']==null){
                            var dt_cad_estoque = "";
                        }
                        else{
                            var dt_cad_estoque = arrCarregar.data[i]['dt_cad_estoque'];
                        }
                        ...
                        strRetorno+="<th width='20%'>"+dt_cad_estoque+"</th>";
...
function fcCancelar(){
    ...
    sendPost("rel_estoque_minimo_res_form.php", {token: token});
}
