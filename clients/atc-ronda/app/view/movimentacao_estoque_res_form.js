...
function fcIncluir(){
    ...
    sendPost('movimentacao_estoque_cad_form.php',{token: token, pk: ''});
...
function fcEditar(v_pk){
    sendPost('movimentacao_estoque_cad_form.php', {token: token, pk: v_pk});
}
...
function fcCarregarGrid(){
    ...
    var v_url = montarUrlController("movimentacao_estoque", "listarDataTable", objParametros);
    ...
    tblResultado = $('#tblResultado').DataTable({
        ...
        "columnDefs": [{
           ...
           {"targets": -2, "data": "t_obs_movimentacao"},
           {"targets": -3, "data": "t_qtde"},
           {"targets": -4, "data": "t_produtos_itens_pk"},
           {"targets": -5, "data": "t_colaborador_pk"},
           {"targets": -6, "data": "t_leads_pk"},
           {"targets": -7, "data": "t_pk"}
