...
?>
<script src="apontamento_folha_ponto_impressao.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
<style>
 #loader {
  position: absolute;
  left: 50%;
...
<div class="container col-sm-12" id="exibir" style="display:none">
        ...
        <div class="noprint">
            ...
            <div class="row" >
                ...
                <div class="col-md-12" align="center" >
                    ...
                    <button type="button" class="btn btn-secondary" id="cmdFinalizar" data-dismiss="modal">Atualizar e Imprimir</button>&nbsp;&nbsp;&nbsp;
            ...
            <div class='row'>
                <div class='col-md-12' align='center'>
                    <h4>Apontamento Folha</h4>
                </div>
            </div>
        </div>
        <div id="grid"></div> 
        <div id="gridPrint"></div>  
