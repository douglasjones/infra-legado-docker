...
?>
<script src="rel_posto_trabalho_colaboradores_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório Posto Trabalho x Colaboradorres</h4>
        </div>
    </div>
