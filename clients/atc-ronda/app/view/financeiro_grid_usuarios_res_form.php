...
<script src="financeiro_grid_usuarios_lancamento_res_form.js" type="text/javascript" charset="utf-8"></script>
<div class="row">
    <div class="col-md-12">
...
<div class='row'>
    <div class='col-md-3'>
        ...
        <div class='col-md-2'>
            ...
            <input type="text" name="leads_pk" id="leads_pk" value="" class='form-control form-control-sm'>
        </div>
    </div>
<div class='row'> 
    <div class="col-md-3">
    ...
    <div class='col-md-2'>
        <label for='ds_num_documento_gridUsuario'>Identificação do Documento:&nbsp;</label>
        <input type="text" class='form-control form-control-sm' id="ds_num_documento_gridUsuario" name="ds_num_documento_gridUsuario"/> 
    </div>
    <div class='col-md-2'>
        <label for='ic_tipo_num_documento_gridUsuario'>Tipo do Documento:&nbsp;</label> 
        <select class='form-control form-control-sm'  id='ic_tipo_num_documento_gridUsuario' name='ic_tipo_num_documento_gridUsuario'>
            <option value=""></option>                               
...
<div class="row"  >
    ...
    <div class='col-md-2'>
        <label for='bancos_pk'>Status de Análise:&nbsp;</label>
...
<div class="row">
    ...
    <div class="col-md-4" align="center">        
        <button type="button" class="btn btn-link" id="cmdPesquisaUsuarioGrid" name="cmdPesquisaUsuarioGrid"><img src="../img/pesquisar.png" width=40 height=40>Pesquisar</button>
    </div>
</div> 
<div class="row">
    <div class="col-md-12">        
