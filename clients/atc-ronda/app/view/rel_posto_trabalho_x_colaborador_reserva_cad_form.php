...
?>
<script src="rel_posto_trabalho_x_colaborador_reserva_cad_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
    ...
    <form id='form'>
        <table>
            <tr>
                ...
                <td>
                    Posto Trabalho x Colaborador Reserva
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <b>Dt Escala Reserva:</b>
                </td>
                <td>
                   <div id="dt_escala_reserva"></div>
                </td>
            </tr>
            <tr>
                <td>
