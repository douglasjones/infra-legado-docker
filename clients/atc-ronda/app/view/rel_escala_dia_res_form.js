...
function fcCarregarGrid(){
    ...
    sendPost('rel_escala_dia_cad_form.php', {token: token, colaboradores_pk: $("#colaboradores_pk").val(),ds_colaboradores: v_ds_colaborador,dt_ini: $("#dt_ini").val(),leads_pk: $("#ds_lead").val(),ds_lead: v_ds_lead});
}
