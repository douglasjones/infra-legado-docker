function fcLimparGridDespesaFormulario() {
    $("#pk_lancamento_despesa").val();
    $("#ic_status_pagamento_despesa").val();
    $("#usuario_cadastro_despesa_pk").val();
    $("#empresa_despesa_pk").val();
    $("#tipo_grupo_despesa_pk").val();
    $("#grupo_leancamento_despesa_pk").val();
    $("#dt_cadastro_ini_despesa").val();
    $("#dt_cadastro_fim_despesa").val();
    $("#dt_faturamento_ini_despesa").val();
    $("#dt_faturamento_fim_despesa").val();
    $("#dt_faturamento_ini_despesa").val();
    $("#dt_faturamento_fim_despesa").val();
    $("#dt_vencimento_ini_despesa").val();
    $("#dt_vencimento_fim_despesa").val();
    $("#dt_pagamento_ini_despesa").val();
    $("#dt_pagamento_fim_despesa").val();
}
...
function fcListarItensGruposDespesa() {
    ...
    if ($("#tipo_grupo_despesa_pk").val() == 1) {
        ...
        carregarComboAjax($("#grupo_leancamento_despesa_pk"), arrCarregar, " ", "pk", "ds_lead");
        ...
        carregarComboAjax($("#grupo_leancamento_despesa_pk"), arrCarregar, " ", "pk", "ds_colaborador");
        ...
        carregarComboAjax($("#grupo_leancamento_despesa_pk"), arrCarregar, " ", "pk", "ds_fornecedor");
    }
}
...
function fcCarregarGridDespesa() {
    try {
        var v_cod = $("#pk_lancamento_despesa").val();
        var v_ic_status = $("#ic_status_pagamento_despesa").val();
        var v_usuario_cadastro_pk = $("#usuario_cadastro_despesa_pk").val();
        var v_ic_status_analise = $("#ic_status_analise").val();
        var v_empresa_pk = $("#empresa_despesa_pk").val();
        var v_tipo_grupo_pk = $("#tipo_grupo_despesa_pk").val();
        var v_grupo_lancamento_pk = $("#grupo_leancamento_despesa_pk").val();
        var v_dt_cadastro_ini = $("#dt_cadastro_ini_despesa").val();
        var v_dt_cadastro_fim = $("#dt_cadastro_fim_despesa").val();
        var v_dt_faturamento_ini = $("#dt_faturamento_ini_despesa").val();
        var v_dt_faturamento_fim = $("#dt_faturamento_fim_despesa").val();
    
        var v_dt_vencimento_ini = $("#dt_vencimento_ini_despesa").val();
        var v_dt_vencimento_fim = $("#dt_vencimento_fim_despesa").val();
        var v_dt_pagamento_ini = $("#dt_pagamento_ini_despesa").val();
        var v_dt_pagamento_fim = $("#dt_pagamento_fim_despesa").val();
        var v_ds_num_documento_despesa = $("#ds_num_documento_despesa").val();
        var v_ic_tipo_num_documento_despesa = $("#ic_tipo_num_documento_despesa").val();
        ...
        var objParametros = {
            ...
            "ds_num_documento": v_ds_num_documento_despesa,
            "ic_tipo_num_documento": v_ic_tipo_num_documento_despesa
        };
    
        var arrCarregar = carregarController("lancamento", "listarDespesaGrid", objParametros);
        var vhtml = "";
        if (arrCarregar.result == 'success') {
            ...
            if (arrCarregar.data.length > 0) {
                ...
                vl_pendente = arrCarregar.data[0]['vl_total_despesa_pendente'];
    
                for (i = 0; i < arrCarregar.data[0].DadosExtratoDespesa.length; i++) {
                    var v_pk = arrCarregar.data[0].DadosExtratoDespesa[i].pk;
                    var v_dt_cadastro = "";
                    var v_ds_usuario = "";
                    var v_ds_empresa = "";
                    ...
                    v_proximo_dt_vencimento = arrCarregar.data[0].DadosExtratoDespesa[i].proxima_data;
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].dt_cadastro != null) {
                        v_dt_cadastro = arrCarregar.data[0].DadosExtratoDespesa[i].dt_cadastro;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_usuario != null) {
                        v_ds_usuario = arrCarregar.data[0].DadosExtratoDespesa[i].ds_usuario;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_empresa != null) {
                        v_ds_empresa = arrCarregar.data[0].DadosExtratoDespesa[i].ds_empresa;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_conta_bancaria != null) {
                        v_ds_conta_bancaria = arrCarregar.data[0].DadosExtratoDespesa[i].ds_conta_bancaria;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].dt_faturamento != null) {
                        v_dt_faturamento = arrCarregar.data[0].DadosExtratoDespesa[i].dt_faturamento;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].dt_vencimento != null) {
                        v_dt_vencimento = arrCarregar.data[0].DadosExtratoDespesa[i].dt_vencimento;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].dt_pagamento != null) {
                        v_dt_pagamento = arrCarregar.data[0].DadosExtratoDespesa[i].dt_pagamento;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_status_pagamento != null) {
                        v_ds_status_pagamento = arrCarregar.data[0].DadosExtratoDespesa[i].ds_status_pagamento;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_operacao != null) {
                        v_ds_operacao = arrCarregar.data[0].DadosExtratoDespesa[i].ds_operacao;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_tipo_operacao != null) {
                        v_ds_tipo_operacao = arrCarregar.data[0].DadosExtratoDespesa[i].ds_tipo_operacao;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_tipo_grupo != null) {
                        v_ds_tipos_grupo = arrCarregar.data[0].DadosExtratoDespesa[i].ds_tipo_grupo;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_recebido_pago_origem != null) {
                        v_recebido_pago_origem = arrCarregar.data[0].DadosExtratoDespesa[i].ds_recebido_pago_origem;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_metodo_pagamento != null) {
                        v_ds_metodo_pagamento = arrCarregar.data[0].DadosExtratoDespesa[i].ds_metodo_pagamento;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].vl_lancamento != null && arrCarregar.data[0].DadosExtratoDespesa[i].operacao_pk == 1) {
                        v_vl_despesa = arrCarregar.data[0].DadosExtratoDespesa[i].vl_lancamento;
                    }
                    ...
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].vl_lancamento != null) {
                        v_vl_lancamento = arrCarregar.data[0].DadosExtratoDespesa[i].vl_lancamento;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ic_status_pagamento != null) {
                        v_ic_status_pagamento = arrCarregar.data[0].DadosExtratoDespesa[i].ic_status_pagamento;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].vl_despesa_pendente_dia == null) {
                        vl_despesa_pendente_dia = "";
                    }else{
                        vl_despesa_pendente_dia = arrCarregar.data[0].DadosExtratoDespesa[i].vl_despesa_pendente_dia;
                    }
                   
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].vl_despesa_dia == null) {
                        vl_despesa_dia = "";
                    }else{
                        vl_despesa_dia = arrCarregar.data[0].DadosExtratoDespesa[i].vl_despesa_dia;
                    }
    
                    if (arrCarregar.data[0].DadosExtratoDespesa[i].ds_lancamento == null) {
                        ds_lancamento = "";
                    }else{
                        ds_lancamento = arrCarregar.data[0].DadosExtratoDespesa[i].ds_lancamento;
                    }
    
                    var v_cor_linha = "";
                    if (v_dt_vencimento < data) {
                        if (arrCarregar.data[0].DadosExtratoDespesa[i].ic_status_pagamento != 1 && v_dt_pagamento == "") {
                            v_cor_linha = "style='color: red'";
    
                            if (arrCarregar.data[0].DadosExtratoDespesa[i].vl_lancamento != null && arrCarregar.data[0].DadosExtratoDespesa[i].operacao_pk == 1) {
                                v_vl_pendente = arrCarregar.data[0].DadosExtratoDespesa[i].vl_lancamento;
                            }
                    ...
                    vhtml += "               <td align='center'>" + v_vl_despesa + "</td>";
                    ...
                    if(v_dt_vencimento != v_proximo_dt_vencimento || v_proximo_dt_vencimento == ""){
                        ...
                        vhtml += "               <td align='center'>" + vl_despesa_dia + "</td>";
                        vhtml += "               <td align='center'><font color='red'>" + vl_despesa_pendente_dia + "</font></td>";
            ...
            vhtml += "               <td width='100' colspan=14 >&nbsp;</td>";
            vhtml += "               <td width='100' ><b>Total R$<b/></td>";
            vhtml += "               <td align='center'>" + vl_despesa + "</td>";
...
function fcPesquisarLancamentosDespesa() {
    if ($("#dt_cadastro_ini_despesa").val() != "" && $("#dt_cadastro_fim_despesa").val() == '') {
        alert('Preencha a Data de Cadastro fim!');
        return false;
    }

    if ($("#dt_faturamento_ini_despesa").val() != "" && $("#dt_faturamento_fim_despesa").val() == '') {
        alert('Preencha a Data de Faturamento fim!');
        return false;
    }

    if ($("#dt_vencimento_ini_despesa").val() != "" && $("#dt_vencimento_fim_despesa").val() == '') {
        alert('Preencha a Data de Vencimento fim!');
        return false;
    }

    if ($("#dt_pagamento_ini_despesa").val() != "" && $("#dt_pagamento_fim_despesa").val() == '') {
...
$(document).ready(function () {
    ...
    $("#dt_vencimento_ini_despesa").val(dia + "/" + mes + "/" + ano)
    $("#dt_vencimento_fim_despesa").val(dia + "/" + mes + "/" + ano)

    $(document).on('click', '#cmdPesqDespesa', function () {
        fcPesquisarLancamentosDespesa();
    });
