...
<script src="condutor_cad_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
				...
				<div class="card-header py-3">	
                    <div class="row">
                        <div class='col-sm-6' align="left">
                            <h6 class="m-0 font-weight-bold text-primary">Novo Condutor</h6>     
                        </div>       
        ...
        <div class="tab-content">
            ...
            <form id="form_lead" class="form">
                ...
                <div class='row'>
                    ...
                    <div class='col-md-4'>
                        <label for='ds_condutor'>Condutor:&nbsp;</label>
                        <input type='text' class='form-control form-control-sm' id='ds_condutor' name='ds_condutor' required >
                    </div>
                </div>
                ...
                <div class='row'>
                    ...
                    <div class='col-md-3'>
                        ...
                        <input type='text' class='form-control form-control-sm' id='ds_cpf' name='ds_cpf' required >
                    </div>
                </div>
                ...
                <div class='row'>
                    ...
                    <div class='col-md-3'>
                        ...
                        <input type='text' class='form-control form-control-sm' id='ds_rg' name='ds_rg' required >
                    </div>
                </div>
