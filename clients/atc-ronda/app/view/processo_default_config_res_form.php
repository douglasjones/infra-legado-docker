...
?>
<script src="processo_default_config_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>

<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Processos Default Configuração</h4>
        </div>
    </div>
    ...
    <form method="post">
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for="processo_default">Processo:&nbsp;</label>
                <select id="processo_default_pk" class="form-control form-control-sm" name="processo_default">
                    <option value=""></option>
                </select>
            </div>
        </div>
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for="processo_default_etapas_pk">Processo Etapas:&nbsp;</label>
                <select id="processo_default_etapas_pk" class="form-control form-control-sm" name="processo_default_etapas_pk">
                    <option value=""></option>
                </select>
            </div>
        </div>
