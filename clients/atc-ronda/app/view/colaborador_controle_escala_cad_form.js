...
function fcFormatarDadosEscala(){    
    ...
    for(i = 0; i< data.length; i++){
        ...
        contratos_itens_pk = data[i]['t_contratos_itens_pk'];
        ...
        n_qtde_dias_semana = data[i]['t_n_qtde_dias_semana'];
        ...
        t_n_qtde_dias_semana = data[i]['t_n_qtde_dias_semana'];
...
function fcEditarAgenda(objRegistro) {
    ...
    $("#colaboradores_pk_combo_agenda").prop("disabled", true); 
...
function fcColaborador() {
    ...
    var objParametros = {
        "contratos_pk": $("#contratos_pk_combo").val(),
        "produtos_servicos_pk_combo": $("#produtos_servicos_pk_combo").val(),
    };

    var arrCarregar = carregarController("colaborador", "listarColaboradorQualidicacaoContrato", objParametros);
...
function liberaRegistroEscala() {
    ...
    if (resultado == true) {
        ...
        $("#print_escala_colaborador").html('')
        $("#colaboradores_pk_combo_agenda option:selected").text('');
    }
}
function fcPreenchimentoAutomatico() {
    ...
    if ($("#ic_preenchimento_automatico").is(":checked") == true) {
        ...
        if ($("#produtos_servicos_pk_combo option:selected").val() == "") {
