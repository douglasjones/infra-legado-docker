...
?>
<script src="rel_posto_trabalho_x_colaborador_reserva_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    ...
    <form id="form" class="form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Data Escala Reserva:</label>
            </div>
        </div>  
