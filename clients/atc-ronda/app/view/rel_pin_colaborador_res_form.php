...
?>
<script src="rel_pin_colaborador_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório Pin Colaboradores</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">
        ...
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for='ds_tel'>Status acesso App Ponto: </label>
                <select type='text' class='form-control form-control-sm'  id='ic_status' name='ic_status'>
                    <option></option>
                    <option value="3">Liberação Não Solicitada</option>
                    <option value="2">Liberação Pendente</option>
