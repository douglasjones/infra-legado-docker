...
?>
<script src="rel_estoque_movimentado_troca_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório Estoque Movimentado Troca</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Categoria:</label>
                <select class='form-control form-control-sm'  id='categorias_pk' name='categorias_pk'>
                    <option></option>
                </select>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Produtos:</label>
