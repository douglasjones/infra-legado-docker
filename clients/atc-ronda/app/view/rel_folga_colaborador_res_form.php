...
?>
<script src="rel_folga_colaborador_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório de Folga Apontamento</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">
        ...
        <div class='row' id="alert_lead" style="display:none">
            <div class='col-md-4'>
                &nbsp;
            </div>
            <div class='col-md-4'>
                <strong style="color: red">Por favor, selecione um Lead!</strong>
            </div>
        </div>
        <p>
        <p>
