<script src="ocorrencia_cad_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
                    ...
                    <div class="modal-body"> 
                        <div class="row">                        
                            ...
                            <div class='col-md-4'>
                                ...
                                <select class=" form-control form-control-sm chzn-select" id="colaborador_pk_ocorrencia" name="colaborador_pk_ocorrencia">
                                    <option></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Fechar</button>
                            <button type="submit" class="btn btn-primary btn-sm" id="cmdEnviarOcorrencia2"  name="cmdEnviarOcorrencia2">Salvar</button>
                        </div>
                    </div>
                </div>
            </div>
