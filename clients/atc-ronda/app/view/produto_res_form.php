...
?>
<script src="produto_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    ...
    <form method="post">
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for="ds_produto">Produtos:&nbsp;</label>
                <input type="text" class="form-control form-control-sm" id="ds_produto" required="true">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
