...
?>
<script src="entrada_estoque_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    ...
    <form method="post">
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for="ds_n_ordem">Produto:&nbsp;</label>
                <input type="text" class="form-control form-control-sm" id="ds_n_ordem" required="true">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
