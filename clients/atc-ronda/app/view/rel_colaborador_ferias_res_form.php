...
?>
<script src="rel_colaborador_ferias_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório Colaboradores Férias</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Data Férias:</label>
            </div>
        </div>  
