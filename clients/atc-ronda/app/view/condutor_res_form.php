...
?>
<script src="condutor_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
				...
				<div class="card-header py-3">	
                    <div class="row">
                        <div class='col-sm-6' align="left">
                            <h6 class="m-0 font-weight-bold text-primary">Condutores</h6>
                        </div> 
                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            ...
                            <div class='col-md-4'>
                                ...
                                <input type="text" class="form-control form-control-sm" id="ds_condutor" required="true">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
