...
?>
<script src="rel_colaborador_curso_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h4>Relatório Colaboradores Cursos</h4>
        </div>
    </div>
    ...
    <form id="form" class="form">
        ...
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for='ds_tel'>Cursos: </label>
                <select type='text' class='form-control form-control-sm chzn-select'  id='cursos_pk' name='cursos_pk'>
                    <option></option>
                </select>
            </div>            
        </div>      
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Data Execucao:</label>
            </div>
        </div>  
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for='clientes_pk'>Data Vencimento:</label>
            </div>
        </div>  
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <input class='form-control form-control-sm'  id='dt_validacao_ini' name='dt_validacao_ini'>
            </div>
            <div class="col-md-2">
                <input class='form-control form-control-sm'  id='dt_validacao_fim' name='dt_validacao_fim'>
            </div>
        </div> 
        <br>
        <hr style='height:1px; border:none; color:#14074F; background-color:#14074F; margin-top: 0px; margin-bottom: 0px;'>
