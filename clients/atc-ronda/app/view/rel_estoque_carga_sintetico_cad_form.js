...
function fcCarregarGrid(){
    ...
    var arrCarregar = carregarController("movimentacao_estoque", "RelatorioEstoqueCargaSintetico", objParametros); 
    ...
    if (arrCarregar.result == 'success'){
        ...
        if(arrCarregar.data.length > 0){   
                    ...
                    for(i=0; i < arrCarregar.data.length ;i++){
                        ...
                        if(arrCarregar.data[i]['qtde']==null){
                            var qtde = "0";
                        }
                        else{
                            var qtde = arrCarregar.data[i]['qtde'];
                        }
                        ...
                        strRetorno+="<th width='20%'>"+qtde+"</th>";
                        strRetorno+="</tr>";
                }
                strRetorno+="</tbody>";
                strRetorno+="</table>";
...
function fcCancelar(){
    ...
    sendPost("rel_estoque_carga_sintetico_res_form.php", {token: token});
}
