...
function fcCarregarGrid(){
    ...
    var arrCarregar = carregarController("colaborador_beneficio", "relColaboradorBebeficio", objParametros); 
    ...
    if (arrCarregar.result == 'success'){
        ...
        if(arrCarregar.data.length > 0){   
                    ...
                    strRetorno+="<th width='20%' style='text-align: center; font-size: 18px'>Benefício</th>";
                    strRetorno+="<th width='20%' style='text-align: center; font-size: 18px'>Valor</th>";   
                    strRetorno+="</tr>";
                    ...
                    for(i=0; i < arrCarregar.data.length ;i++){
                        ...
                        strRetorno+="<th width='20%'>"+arrCarregar.data[i]['ds_beneficio']+"</th>";
                        strRetorno+="<th width='20%'>"+arrCarregar.data[i]['vl_beneficio']+"</th>";
                        strRetorno+="</tr>";
                }
                strRetorno+="</tbody>";
                strRetorno+="</table>";
...
function fcCancelar(){
    ...
    sendPost("rel_colaborador_beneficio_res_form.php", {token: token});
}
