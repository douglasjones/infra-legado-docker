(function() {
  ...
  callWithJQuery(function($) {
    ...
    return $.pivotUtilities.gchart_renderers = {
      "Gráfico de Linhas": makeGoogleChart("LineChart"),
      "Gráfico de Barras": makeGoogleChart("ColumnChart"),
      "Gráfico de Pilhas": makeGoogleChart("ColumnChart", {
        isStacked: true
      }),
      "Gráfico de Áreas": makeGoogleChart("AreaChart", {
        isStacked: true
      }),
      "Gráfico de Dispersão": makeGoogleChart("ScatterChart")
    };
  });
