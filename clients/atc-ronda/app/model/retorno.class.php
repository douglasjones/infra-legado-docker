...
class retorno{
    ...
    function gettipo_lembrete_pk(){return $this->tipo_lembrete_pk;}
    ...
    function settipo_lembrete_pk($tipo_lembrete_pk){ $this->tipo_lembrete_pk = $tipo_lembrete_pk;}
