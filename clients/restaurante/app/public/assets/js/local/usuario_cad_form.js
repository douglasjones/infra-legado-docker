function fcEnviar(){
    if($("#grupos_pk").val()==''){
        utilsJS.toastNotify(false, 'Por favor informe o Grupo!');
        return false;
    }

    if($("#ds_usuario").val()==''){
        utilsJS.toastNotify(false, 'Por favor informe o Usuário!');
        return false;
    }

    if($("#ds_email").val()==''){
        utilsJS.toastNotify(false, 'Por favor informe o Login!');
        return false;
    }
