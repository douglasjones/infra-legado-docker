...
function fcEnviar(){
    try {
        ...
        if($('#ds_colaborador').val()==""){
            utilsJS.toastNotify(false,"Por favor, informe Colaborador");
        ...
        if($('#ds_cpf').val()==""){
            utilsJS.toastNotify(false,"Por favor, informe CPF");
            $('#ds_cpf').focus();
            return false;
        }
...
function fcEnviarEscala(){
    ...
    if($("#tipo_escala_pk").val()==""){
        utilsJS.toastNotify(false,"Por favor, informe o Tipo Escala");
        return false;
    }
