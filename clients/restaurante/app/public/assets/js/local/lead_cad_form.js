...
function fcEnviarEscala(){
    ...
    if($("#escala_colaborador_pk").val()==""){
        utilsJS.toastNotify(false,"Informe o colaborador!");
        return false;
    }

    if($("#dt_inicio_agenda").val()==""){
        utilsJS.toastNotify(false,"Informe a Data Inicio!");
        return false;
    }
    if($("#dt_fim_agenda").val()==""){
        utilsJS.toastNotify(false,"Informe a Data Fim!");
        return false;
    }
    if($("#tipo_escala_pk").val()==""){
        utilsJS.toastNotify(false,"Informe o Tipo Escala!");
        return false;
    }
