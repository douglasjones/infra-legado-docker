...
CONTAINER_NAME="${CONTAINER_NAME:-vistoriza-at-mysql}"
...
DUMP_GZ="${DUMP_GZ:-${BACKUP_DIR}/gepros1com_vistoriza.sql.gz}"
CONTAINER_TMP_PATH="${CONTAINER_TMP_PATH:-/tmp/vistoriza_at_dump.sql}"
