...
if(!empty($mailing))
	$sql.=" and trim(l.mailing) = '".trim($mailing)."' ";
...
<table width="100%" height="100%"  align="center" border="0" cellpadding="0" cellspacing="0" class="form" >
    ...
    <tr>
        <td>
            <label for="agendadopara">Agendado para Operadora:</label>
        </td>
        <td>
	...
	<td>
		<?	
			$sql ="";
			$sql.="select mailing, mailing ";
			$sql.="  from leads ";
			$sql.=" group by mailing ";
    ...
    <tr>
        ...
        <td>
            <select name="cod_tamanho_visita">
                <option value=""> </option>
                <option value="1" <?if($cod_tamanho_visita==1){?>selected="selected"<?}?>>Pequena 1 a 5</option>
                <option value="2" <?if($cod_tamanho_visita==2){?>selected="selected"<?}?>>Média 6 a 10</option>
                <option value="3" <?if($cod_tamanho_visita==3){?>selected="selected"<?}?>>Grande Acima de 10</option>
            </select>
        </td>
    </tr>			
    <tr>
                  ...
                  ?>           
                            <div class="agendamento <?=(!empty($agenda['CodStatus'])?'status' . $agenda['CodStatus']:null);?> <?=$reagendamento;?>">
                              ...
                              <?
                                ...
                                if(empty($agenda['CodStatus']) || $agenda['CodStatus']== '6'){
                                    $acao = "ins";                                   
                                    //if((($acao == 'ins' && permissao('informacaovisita', 'ic')) || ($acao == 'upd' && permissao('informacaovisita', 'al')))){
                                    if(permissao('informacaovisita', 'ic')){    
                              ?>
                                        <a href="../../vendas/leads/leadsagendainformacao.php?codagendalead=<?=$agenda['CodAgendaLead'];?>&codlead=<?=$agenda['CodLead'];?>&lytebox=1" class="lytebox" data-lyte-options="width:700 height:300"><img border=0 src='../../images/classificacao_visita.png' width=20 height=20 title="Classificar Visita" ></a><?
                                    }
                              ...
                              ?>
                                ...
                                }else if($agenda['CodStatus']==1){
                                    if(permissao('proposta', 'ic')){
                              ?>
                                        <a href="seleciona_proposta.php?codlead=<?=$agenda['CodLead'];?>&codagendalead=<?=$agenda['CodAgendaLead'];?>" class="lytebox" data-lyte-options="width:500 height:100"><img border=0 src='../../images/proposta1.png' width=20 height=20 title="Nova Proposta" ></a>             
                              <?
                                    }
                                }
                              ?>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" class="form">
	...
	<tr>
    	<table width="800" align="center"  class="form">
        	<tr>
                ...
                <td width="200" align="center" class="status6">Auditado</td>
