...
if ($acao == "gravar"){	
    ...
    $propostas->setdt_cancelamento($dt_cancelamento);
...
if($acao == "enviar_email"){
        ...
        $assunto="PROPOSTA OI";
                    ...
                    $sql ="SELECT np.pk,
                              ...
                              WHERE l.CodLead =".$leads_pk;
                                ...
                                $email_consultor = $row2['email_consultor'];
    ...
    if($row1['enviar_proposta_email_pk']==1){
        ...
        if($row1['origem_email_proposta_pk']==1){
            ...
            email::envia_email_proposta($html,$row1['email_usuario'],$email_contato,$body,$msg_body,$assunto,$operador_pk,$nomecontato,$leads_pk,$email_consultor);
        }elseif($row1['proposta_email']){
            
            $row1['email_usuario'] = $row1['proposta_email'] ;
