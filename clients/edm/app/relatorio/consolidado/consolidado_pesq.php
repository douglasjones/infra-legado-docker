...
if(!(($acao == 'cs' && permissao('rel_finul', 'cs')) || ($acao == 'upd' && permissao('rel_funil', 'al')))){
...
<form name="dados" method="get" action="consolidado_res.php" target="pagina">
<table border="0" cellpadding="0" cellspacing="0" class="form" align="center" width="100%">
	...
	<tr>
		...
		<td>
		<?
		$sql = "select codstatusclassificacaolead, descricao from statusclassificacaolead where codstatusclassificacaolead not in (1) order by 1 ";
