...
$where = "";
	...
	$sql = "Select 
			...
			from leads l 
				  ...
				  inner join n_data_proposta_operador ndpo on ndp.data_proposta_operador_pk = ndpo.pk and ndpo.ds_data='Cliente'	  
	...
	$sql.=" group by l.codlead, ndp.pk, ndp.vl_data_proposta";
