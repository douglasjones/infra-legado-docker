...
<head>
    ...
    <!--Cabeçalho-->
    <title>Relatório Pepeline Forecast Analitico</title>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <form name="dados" method="get" action="pipeline_forecast_analitico_res.php" id="formula" target="pagina">
<input type="hidden" name="dirrel" value="agendamento">
<input type="hidden" name="pgrel" value="relagendamentores.php">
<table width="100%" align="center"  height="5"  class="topo"  cellpadding="0" cellspacing="0">
	<tr>
		 <td  class="titulo"> 
			Pipeline Forecast Análitico
		</td>
	</tr>
</table>		
