...
if(!(($acao == 'cs' && permissao('relfaturasinpesq.php', 'cs')) || ($acao == 'upd' && permissao('relfaturasinpesq.php', 'al')))){
...
<title>Relatório de Faturamento Sintético</title>
...
<input type="hidden" name="dirrel" value="faturamento_sintetico">
<input type="hidden" name="pgrel" value="relfaturasinres.php">
