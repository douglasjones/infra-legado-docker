...
<head>
    ...
    <!--Cabeçalho-->
	<title>Distribuição Carteira Atendente</title>
...
<form name="dados" method="get" action="distri_carteira_atendente_res.php" target="pagina">
