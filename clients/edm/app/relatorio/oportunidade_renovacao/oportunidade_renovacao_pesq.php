...
if(!(($acao == 'cs' && permissao('rel_oportunidade', 'cs')) || ($acao == 'upd' && permissao('rel_oportunidade', 'al')))){
...
<form name="dados" method="get" action="oportunidade_renovacao_res.php" target="pagina">
<table border="0" cellpadding="0" cellspacing="0" class="form" align="center" width="100%">
	...
	<tr>
		...
		<td>
			<input type="text" id="qtde_dias" name="qtde_dias" size="12" maxlength="10" />
		</td>	
	</tr>
	<tr>
