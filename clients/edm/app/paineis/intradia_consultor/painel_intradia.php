...
<head>
	...
	<script>
		...
		function exibirGrafico(){
			if(indice == 1){
				titulo.innerHTML = "Linhas<br>(Dia)";
				...
				titulo.innerHTML = "Linhas<br>(Mês)";
				var chart = new FusionCharts("../swf/FCF_StackedBar2D.swf", "ChartId", "1200", "600");
				...
				titulo.innerHTML = "Linhas por Equipe<br>(Mês)";
				var chart = new FusionCharts("../swf/FCF_StackedBar2D.swf", "ChartId", "1200", "600");
				chart.setDataURL("contratos_gerados_equipe_mes.php");
				chart.render("painel_dia");		
				indice = 1;
			}			
