...
<head>
	...
	<script>
		...
		var indice = 1;
		var intervalo = window.setInterval(exibirGrafico, 60000);
	
		function exibirGrafico(){			
			titulo.innerHTML = "Ocorrências Geradas<br>(Dia por Tipo Pessoa)";
			var chart = new FusionCharts("../swf/FCF_StackedBar2D.swf", "ChartId", "1200", "600");
			chart.setDataURL("ocorrencias_natureza_xml.php");		   
