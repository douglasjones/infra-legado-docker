	...
	<script>
		...
		function exibirGrafico(){
			...
			if(indice == 1){
				...
				chart.setDataURL("../intradia/ocorrencias_geradas_dia.php");		   
				chart.render("painel_dia");					
				indice = 2;
			}
			else if(indice == 2){
				titulo.innerHTML = "Agendamentos<br>(Dia)";
				var chart = new FusionCharts("../swf/FCF_StackedBar2D.swf", "ChartId", "1200", "600");
				chart.setDataURL("../intradia_agendamento/agendamento_gerados_dia.php");
				chart.render("painel_dia");		
				indice = 3;
			}
			else if(indice == 3){
				titulo.innerHTML = "Agendamentos<br>(Mês)";
				var chart = new FusionCharts("../swf/FCF_StackedBar2D.swf", "ChartId", "1200", "600");
				chart.setDataURL("../intradia_agendamento/agendamento_gerados_mes.php");		   
				chart.render("painel_dia");		
				indice = 1;			
			}
