	...
	<script>
		...
		function exibirGrafico(){
			...
			if(indice == 1){
				...
				chart.setDataURL("agendamento_gerados_dia.php");		   
				...
				var chart = new FusionCharts("../swf/FCF_StackedBar2D.swf", "ChartId", "1200", "600");
				chart.setDataURL("agendamento_gerados_mes.php");
				chart.render("painel_dia");		
				indice = 1;
			}
...
<table border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td align="center"><font face="Arial" size="+2"><b><span id="titulo"></span></b></font></td>
	</tr>
</table>
