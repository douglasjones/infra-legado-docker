...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="carregar()">
	<form name="dados" method="post" action="n_aparelhos_res_form.php" target="pagina">
		<input type='hidden' name='acao' id='acao' value='' />
		<input type='hidden' name='pk' value='<?= $pk;?>' />
		<input type='hidden' name='ds_link_imagem' value='<?= $ds_link_imagem;?>' />
...
<table width="100%" height="100%"  align="center" border="0" cellpadding="1" cellspacing="1" class="form">
	...
	<tr>
		<td colspan="2" align="center" >					
			<input type='button' name='cmdEnviar' id='cmdEnviar' value="Enviar"  onclick="document.forms[0].submit();self.close();" />			 
