...
CONTAINER_NAME="${CONTAINER_NAME:-vs-solucoes-mysql}"
DB_NAME="${DB_NAME:-gepros1com_vs_solucoes}"
DB_USER="${DB_USER:-root}"
DB_PASSWORD="${DB_PASSWORD:-SENHA}"
DB_CHARSET="${DB_CHARSET:-latin1}"
DB_COLLATION="${DB_COLLATION:-latin1_swedish_ci}"
DUMP_SQL="${DUMP_SQL:-${BACKUP_DIR}/gepros1com_vs_solucoes.sql}"
DUMP_GZ="${DUMP_GZ:-${BACKUP_DIR}/gepros1com_vs_solucoes.sql.gz}"
CONTAINER_TMP_PATH="${CONTAINER_TMP_PATH:-/tmp/vs_solucoes_dump.sql}"
