function fcSalvar() {
    try{
        ...
        if (arrCarregar0.status == true && arrCarregar0.data.length > 0) {
...
function fcCadastrarEscala() {
    ...
    if (arrEnviar.status == true) {
        utilsJS.sweetMensagem(true, "Registro cadastrado com sucesso!", routes('agenda_colaborador_padrao','receptivoEscala',{}));
    } else {
