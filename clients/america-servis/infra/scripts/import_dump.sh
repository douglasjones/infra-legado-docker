...
CONTAINER_NAME="${CONTAINER_NAME:-america-mysql}"
DB_NAME="${DB_NAME:-gepros1com_americaservis}"
DB_USER="${DB_USER:-root}"
DB_PASSWORD="${DB_PASSWORD:-SENHA}"
DB_CHARSET="${DB_CHARSET:-latin1}"
DB_COLLATION="${DB_COLLATION:-latin1_swedish_ci}"
DUMP_SQL="${DUMP_SQL:-${BACKUP_DIR}/americaservs_full.sql}"
DUMP_GZ="${DUMP_GZ:-${BACKUP_DIR}/americaservs_full.sql.gz}"
CONTAINER_TMP_PATH="${CONTAINER_TMP_PATH:-/tmp/americaservs_full.sql}"
...
VERIFY_SCRIPT="${VERIFY_SCRIPT:-${ROOT_DIR}/scripts/verificar_dump.sh}"
