    ...
    public function pegarInfoColaborador(Request $request, Response $response, $args){
        try{
            ...
            if(count($retorno->data)>0){
                ...
                $retornoLeads = (new AgendaColaboradorPadrao($this->pdo))->verificaOutraEscalaColaborador($retorno->data[0]['colaborador_pk']);


                //VERFICAR SE BATEU OS PONTOS HOJE 
                $retornoPonto = (new Ponto($this->pdo))->pegarPontoBatidoHoje($retorno->data[0]['colaborador_pk']);
