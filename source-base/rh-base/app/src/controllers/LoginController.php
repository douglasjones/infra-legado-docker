...
final class LoginController extends BaseController {
    ...
    public function loginSistema(Request $request, Response $response, $args) {
        try{
            session_destroy();
            Session::cleanSession();
            $entity = new Login($this->pdo);
            $retorno = $entity->login($request->getParsedBody());
            $this->view->render($response, 'login/loginSistema.twig');
            return $response;
        } catch (Throwable $th) {
            return $response->withJson((object)[
                'error' => $th->getMessage()
	...
	public function recuperarSenha(Request $request, Response $response, $args) {
        try{
            Session::cleanSession();
            $this->view->render($response, 'login/recuperar.twig');
            return $response;
        } catch (Throwable $th) {
            return $response->withJson((object)[
                'error' => $th->getMessage()
