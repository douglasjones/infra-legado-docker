                    ...
                    if(arrCarregarP.data!=null){
                        if(arrCarregarP.data.length > 0){
                            ...
                            for(j=0; j < arrCarregarP.data.length ;j++){
                               ...
                               //if(ds_imagem_entrada==null && arrCarregarP.data[j]['img_ponto']!='<img width="60" height="60" src="data:image/png;base64,">'){
                                ...
                                //}
                                //else{
                                   // strRetorno+="<td align=center  width='40%' class='galeria'>Ponto Manual (PIN)</td>";
                                ...
                                strRetorno+="<td align=center  width='60%'><a onclick='fcAbrirMapa("+'"'+ds_local_trabalho+'"'+","+'"'+$ds_localizacao+'"'+")'><span><img width=18 height=18 src='/assets/img/maps.png' title='Maps'></span></a></td>";
                                strRetorno+="</tr>";
