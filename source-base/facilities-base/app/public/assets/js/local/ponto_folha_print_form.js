                                ...
                                $("#totalLinhas").val(arrCarregar.data[0].registrosfolha.length);
                                    ...
                                    if (typeof arrCarregar.data[0].registrosfolha[0].ponto_folha_registro_pk !== 'undefined') {
                                        for (i = 0; i < arrCarregar.data[0].registrosfolha.length; i++) {
                                            ...
                                            v_html += "    </td>";
                                            v_html += "    <td style=' text-align: center'>";
                                            v_html += "<span "+ (ic_status == 1 ? " " : "") +" id='hr_excedentes" + i + ""+colaborador_pk.trim()+"' size='3' onkeypress='mascara(this,horamask)'>"+hr_excedentes+"</span>";
                                            v_html += "    </td>";
                                            v_html += "    <td style=' text-align: center'>";
                                            v_html += "<span "+ (ic_status == 1 ? " " : "") +" id='hr_faltantes" + i + ""+colaborador_pk.trim()+"' size='3' onkeypress='mascara(this,horamask)'>"+hr_faltantes+"</span>";
                                            v_html += "    </td>";
                                            v_html += "    <td style=' text-align: center'>";
                                            v_html += "<font size='1,7'><span id='ds_situacao" + i + ""+colaborador_pk.trim()+"'>" + ds_situacao + "</span></font>";
                                            v_html += "    </td>";
                                            v_html += "    <td style=' text-align: center'>";
                                            v_html += "<span "+ (ic_status == 1 ? " " : "") +" id='hr_extra50" + i + ""+colaborador_pk.trim()+"' size='3' value='" + hr_extra50 + "' onkeypress='mascara(this,horamask)'>"+hr_extra50+"</span>";
                                            v_html += "    </td>";
                                            v_html += "    <th style=' text-align: center'>";
                                            v_html += "<span "+ (ic_status == 1 ? " " : "") +" id='hr_extra100" + i + ""+colaborador_pk.trim()+"' size='3' value='" + hr_extra100 + "'>"+hr_extra100+"</span>";
                                            v_html += "    </td>";
                                            v_html += "    <td style=' text-align: center'>";
                                            v_html += "<span "+ (ic_status == 1 ? " " : "") +" id='hr_adicional_noturno" + i + ""+colaborador_pk.trim()+"' size='3' onkeypress='mascara(this,horamask)'>"+hr_adicional_noturno+"</span>";
                                            v_html += "    </td>";
                                            v_html += "    <td style=' text-align: center'>";
                                            v_html +=       obs;
                                            v_html += "    </td>";
                                    ...
                                    v_html += "    </td>";
                                    v_html += "    <td  style=' text-align: center'>";
                                    v_html += "       <span id='ht_total"+colaborador_pk.trim()+"' name='ht_total' size='3' maxlength='8'  value='" + v_ht_total + "'>"+v_ht_total+"</span>";
                                    v_html += "    </td>";
                                    v_html += "    <td  style=' text-align: center'>";
                                    v_html += "       <span id='he_total"+colaborador_pk.trim()+"' name='he_total' size='3' maxlength='6' value='" + v_he_total + "' onkeypress='mascara(this,horamask)'>"+v_he_total+"</span>";
                                    v_html += "    </td>";
                                    v_html += "    <td  style=' text-align: center'>";
                                    v_html += "       <span id='hf_total"+colaborador_pk.trim()+"' name='hf_total' size='3' maxlength='6' value='" + v_hf_total + "'  onkeypress='mascara(this,horamask)'>"+v_hf_total+"</span>";
                                    v_html += "    </td>";
                                    v_html += "    <td  style=' text-align: center'>";
                                    v_html += "      &nbsp;";
                                    v_html += "    </td>";
                                    v_html += "    <td  style=' text-align: center'>";
                                    v_html += "       <span id='he1_total"+colaborador_pk.trim()+"' name='he1_total' size='3' maxlength='6' value='" + v_he1_total + "' onkeypress='mascara(this,horamask)'>"+v_he1_total+"</span>";
                                    v_html += "    </td>";
                                    v_html += "    <td style=' text-align: center'>";
                                    v_html += "       <span id='he2_total"+colaborador_pk.trim()+"' name='he2_total' size='3' maxlength='6' value='" + v_he2_total + "' onkeypress='mascara(this,horamask)'>"+v_he2_total+"</span>";
                                    v_html += "    </td>";
                                    v_html += "    <td  style=' text-align: center'>";
                                    v_html += "       <span id='an_total"+colaborador_pk.trim()+"' name='an_total"+colaborador_pk.trim()+"'  maxlength='6' value='" + v_an_total + "' onkeypress='mascara(this,horamask)'>"+converHrs(v_an_total)+"</span>";
                                    v_html += "    </td>";
                                    ...
                                    // O HTML acumulado e inserido uma unica vez apos processar todos os colaboradores.
